...
EXPECTED={'2025-12':44640,'2026-01':44640,'2026-02':40320,'2026-03':44640,'2026-04':43200}
def sha256(p):
 h=hashlib.sha256()
...
def download(url,out,retries=5):
 ...
 for n in range(retries):
  ...
  try:
   req=urllib.request.Request(url,headers={'User-Agent':'FQT-OSV4-IP04A/1.0'})
